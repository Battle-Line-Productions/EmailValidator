...
{
    Task<ValidationResult<RegexValidationResult>> IsValidSimpleAsync(string email);
    Task<ValidationResult<RegexValidationResult>> IsValidAsync(string email, Regex customRegex);
}